  ...
  return (
    <>
      ...
      <main>
        ...
        <Experts
          title={exprtSpan}
          text="Hit us a message, or give us a call, and make the most of our <a href='/ghostwriting-services' class='textdocationnone text-white hover'>Professional Book Writers</a>."
          number="(012) 345 6789"
