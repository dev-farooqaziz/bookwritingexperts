                    ...
                    <Row>
                        <Col md={12}>
                            ...
                            <ul>
                                ...
                                <li className='font-f'><strong>Email: </strong> <Link className='colortextgrey font-f textdocationnone' href="mailto:support@xyz.com">support@xyz.com</Link>
                                </li>
                                <li className='font-f'><strong>Phone: </strong> <Link className='colortextgrey font-f textdocationnone' href="tel:+1302 883-8877">(012) 345 6789</Link>
                                </li>
