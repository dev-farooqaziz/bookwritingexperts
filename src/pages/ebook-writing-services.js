...
const EbookWritingservices = () => {
  ...
  const bannertext = [
    {
      ...
      homebannernum: 'Call Us at (012) 345 6789',
  ...
  const text = <span>Get in touch with our professional <a class='textdocationnone textcolor hover' href="/book-writing-services">book writing</a>  specialists today. Our eBooks Writing Experts choose the most compelling words and perfect linguistics for your work. We promise original, customized, and timely delivery of your content without breaking your bank!
  </span>;
    ...
    <>
      ...
      <div className='datacloud'>
        <Aspiring
          ...
          number="Call Now At (012) 345 6789"
        />
      </div>
    </>
  )
