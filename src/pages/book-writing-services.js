...
const Bookpublishingservices = () => {
  ...
  const reasons = [
    ...
    
    {
      ...
      text: "We understand the importance of cost-effectiveness. Our services are designed to make <a href='/book-publishing-services' class='textdocationnone color-blue hover fw700'>  book publishing</a> affordable for authors, allowing you to manage your budget effectively",
      classnum: 'number1',
    ...
    <>
      ...
      <div className='datacloud'>
        <Aspiring
          ...
          number="Call Us at (012) 345 6789"
