                    ...
                    <div className={styles.termsofuse}>
                        ...
                        <ul>
                            <li className='font15  textcolor font-f'>
                                Toll-Free number: <Link className='textdocationnone color-blue hover' href="tel:(012) 345 6789">(012) 345 6789</Link>
                            </li>
                            <li className='font15  textcolor font-f'>
                                E-mail: <Link className='textdocationnone color-blue hover' href="mailto:support@xyz.com">support@xyz.com</Link>
                            </li>
                        </ul>
