            ...
            <div className={styles.contactbg}>
                ...
                <Container>
                    <Row className='gy-4'>
                        <Col md={5}>
                            ...
                            <div className={`${styles.published} pt-5`}>
                                ...
                                <p className='font20 fw500 font-f color-white'>
                                    <span className=''>Phone:</span> <Link href='tel:(012) 345 6789' className={` ${styles.numpost} fw700 color-white textdocationnone`}> (012) 345 6789 </Link>
                                </p>
                                <p className='font20 fw500 font-f color-white'>
                                    <span className=''>Email:</span> <Link href='mailto:info(@)xyz(.)com' className={` fw700 color-white textdocationnone`}>
                                    support(@)xyz(.)com </Link>
                                </p>
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d34214.15736453365!2d-74.03362171261661!3d40.71509217602136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY!5e0!3m2!1sen!2sus!4v1740076752071!5m2!1sen!2sus" width="100%" height="252"></iframe>
