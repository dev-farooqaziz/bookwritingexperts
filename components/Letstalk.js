            ...
            <Col md={6} className={styles.newtown2}>
              ...
              <div className={styles.social}>
                ...
                <div className={styles.gosto}>
                  ...
                  <ul>
                    <li> <Link href="https://www.facebook.com/">  <Image alt="Book Writing Experts" src={fb} className='img-fluid' /> </Link> </li>
                    <li> <Link href="https://twitter.com/">  <Image alt="Book Writing Experts" src={xx} className='img-fluid' /> </Link> </li>
                    <li> <Link href="https://www.instagram.com/">  <Image alt="Book Writing Experts" src={insta} className='img-fluid' /> </Link> </li>
                    <li> <Link href="https://www.linkedin.com/">  <Image alt="Book Writing Experts" src={you} className='img-fluid' /> </Link> </li>
                    <li> <Link href="https://www.youtube.com/">  <Image alt="Book Writing Experts" src={link} className='img-fluid' /> </Link> </li>
                  </ul>
                </div>
              </div>
              ...
              <div className={styles.down}>
                ...
                <div className={styles.flow1}>
                  ...
                  <div className={styles.major}>
                    <Link href="mailto:support@xyz.com">  <Image src={email} className='img-fluid' /> support@xyz.com</Link>
                  </div>
                ...
                <div className={styles.flow2}>
                  ...
                  <div className={styles.major}>
                    <Link href="tel:0123456789">  <Image src={tel} className='img-fluid' /> (012) 345 6789</Link>
                  </div>
                </div>
