            ...
            <Navbar.Collapse id="basic-navbar-nav" className={styles.navalign}>
                        ...
                        <ul className={styles.border}>
                          <li className={styles.navlinks}>
                            ...
                            <div className={`${styles.megaImgTxt} mt-4`}>
                              ...
                              <Link href="tel:0123456789" className='text-white'>Book A Free Call
                                <FaLocationArrow />
                              </Link>
                            </div>
                          </li>
              ...
              <ul className={styles.align_menu}>
                <li className={navbarCtaColor || slug ? `${styles.headerTelCbi}` : `${styles.headertel} ${styles.navlinks}`}>
                  ...
                  <Link className={navbarCtaColor || slug ? `${styles.headerbtnCBIcolor} ${styles.headerCBIicon}` : `${styles.headerbtncolor} ${styles.headericon}`} href="tel:(012) 345 6789">

                    <BsFillTelephoneFill className={styles.valuenum} size={12} /> (012) 345 6789 </Link>
