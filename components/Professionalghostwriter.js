    ...
    <div className={styles.professionalghostwriter}>
      <Container>
        <Row className={styles.writercenter}>
          ...
          <Col md={6}>
            <h2>
              <Link className='color-blue font50 font-f textdocationnone' href="/">Book Writing Experts </Link>
              Is waiting for you to Ask for a <Link className='color-blue font50 font-f textdocationnone' href="/">Professional Ghostwriter</Link></h2>
