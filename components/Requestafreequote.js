            ...
            <Col md={4}>
              <div>
                ...
                <p className={styles.bookemail}><MdEmail size={16} />
                  ...
                  <Link className={`${styles.emailhref} hover`} href="mailto:support@xyz.com">  support@xyz.com </Link> </p>
              </div>
            </Col>
            <Col md={4}>
              <div>
                ...
                <p className={styles.bookemail}><BsFillTelephoneFill size={12} />
                  ...
                  <Link className={`${styles.emailhref} hover`} href="tel:(012) 345 6789"> (012) 345 6789 </Link> </p>
              </div>
            </Col>
          </Row>
        </Container>
