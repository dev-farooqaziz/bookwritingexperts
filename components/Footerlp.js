        ...
        <Container>
          <Row className='pb-4 footercolset'>
            <Col md={4}>
              ...
              <ul className={styles.footermenu1}>
                <li className={`${styles.footermenulinks} mt-4`}><MdEmail size={16} />  <Link className={styles.styleset} href="mailto:support@xyz.com"><Image src={email} alt="Book Writing Experts" /></Link></li>
                <li className={`${styles.footermenulinks} ${styles.footermenulinks2} pt-3`}>   <BsFillTelephoneFill size={12} /> Toll Free:<Link className={styles.styleset} href="tel:0123456789"> (012) 345-6789 </Link></li>
                ...
                <li className={`${styles.footermenulinks} ${styles.footerdo} pt-3`}>  <Image src={location} className='img-fluid' /> Office abc street, New York </li>
              </ul>

              <ul className={styles.socialiconfooter}>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.facebook.com/">
                  <Image src={social1} className='img-fluid' /> </Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://twitter.com/"> <Image src={social2} className='img-fluid' /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.instagram.com/"> <Image src={social3} className='img-fluid' /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.linkedin.com/"> <Image src={social4} className='img-fluid' /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.youtube.com/"> <Image src={social5} className='img-fluid' /></Link></li>
              </ul>
          ...
          <div className={styles.footerborder}>
            <Row className='pt-2'>
              ...
              <Col md={4}>
                <p className='font14 text-center font-f'>© 2024 - All Rights Reserved <Link className='font14 text-center font-f text-white text-decoration-none' target='_blank' href="javascripts:;"></Link></p>
              </Col>
              <Col md={4}>
