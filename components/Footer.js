        ...
        <Container>
          <Row className='pb-5 footercolset'>
            <Col md={4}>
              ...
              <ul className={styles.footermenu1}>
                <li className={`${styles.footermenulinks} ${styles.footermenulinks2} mt-4`}><MdEmail size={16} />  <Link className={styles.styleset} href="mailto:support@xyz.com"> support@xyz.com</Link></li>
                ...
                <li className={`${styles.footermenulinks} pt-3`}> <ImLocation2 size={16} /> Office abc street, New York </li>
              ...
              <ul className={styles.socialiconfooter}>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.facebook.com/"><RiFacebookBoxFill size={20} /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://twitter.com/"><AiOutlineTwitter size={17} /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.instagram.com/"><AiOutlineInstagram size={17} /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.youtube.com/"><BsYoutube size={17} /></Link></li>
                <li className={styles.socaillinks}><Link className={styles.styleset} href="https://www.linkedin.com/"><FaLinkedinIn size={17} /></Link></li>
              </ul>
          ...
          <div className={styles.footerborder}>
            <Row className='pt-2'>
              ...
              <Col md={4}>
              <p className='font14 text-center font-f'>© 2024 - All Rights Reserved - <Link className='font14 text-center font-f text-white text-decoration-none' target='_blank' href="javascripts:;">Mini Investment</Link></p>
              </Col>
              <Col md={4}>
